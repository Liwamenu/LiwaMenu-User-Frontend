...
import {
  ...
  PAGE_DURATION_MIN_MS,
  PAGE_DURATION_MAX_MS,
  PAGE_DURATION_STEP_MS,
...
const ThemeSelector = ({ data }) => {
  ...
  return (
    <div className="w-full pb-8 mt-1 text-[--black-1]">
      ...
      {/* Additional TV screens (screen 2+) — one card per extra TV license.
          Screen 1 is configured above; this manages the rest. */}
      <TvScreensManager data={data} />
    </div>
  );
};
